...
public class ConfigController {
	...
	@CrossOrigin
	@RequestMapping(value = "/getJsonFields", method = RequestMethod.POST,consumes=MediaType.MULTIPART_FORM_DATA_VALUE)
	public @ResponseBody Map<String,String> getJsonFields(@RequestParam("file") MultipartFile inputFile) {
		...
		Map<String,String> jsonFieldsMap= DynamicJsonProcessor.parseJsonInputLine(line, "","", new HashMap<String, String>());
