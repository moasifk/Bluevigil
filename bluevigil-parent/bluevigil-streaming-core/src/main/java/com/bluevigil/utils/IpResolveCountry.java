...
public class IpResolveCountry extends EvalFunc<String> {
  ...
  Broadcast<DatabaseReader> broadcastedDBReader;
...
public Broadcast<DatabaseReader> getBroadcastedDBReader() {
	return broadcastedDBReader;
}



public void setBroadcastedDBReader(Broadcast<DatabaseReader> broadcastedDBReader) {
	this.broadcastedDBReader = broadcastedDBReader;
}
